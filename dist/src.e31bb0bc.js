...
class HomeView {
  ...
  pageIntroAnim2() {
    _gsap.default.fromTo(".subheading", {
      x: -1000,
      opacity: 0
    }, {
      x: 0,
    ...
    _gsap.default.from(".shop-graduates-btn", {
      x: -2000,
      opacity: 0
    }, {
      x: 0,
