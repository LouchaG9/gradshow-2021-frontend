...
const Graduates = [{
  ...
  tagLine: "As long as we're enjoying ourselves, that's the most important thing.",
  portfolio: "",
...
class student19760513View {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), student19760513[0].avatarTwo, student19760513[0].avatarOne, student19760513[0].major, student19760513[0].firstName, student19760513[0].lastName, student19760513[0].tagLine, student19760513[0].firstName, student19760513[0].bio, student19760513[0].portfolio, student19760513[0].linkedin, student19760513[0].instagram, student19760513[0].dribbble, student19760513[0].artStation, student19760513[0].behance, student19760513[0].twitter, student19760513[0].vimeo, student19760513[0].firstName);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
customElements.define("va-app-header", class AppHeader extends _litElement.LitElement {
  ...
  render() {
    return (0, _litElement.html)(_templateObject(), this.hamburgerClick, _Router.gotoRoute, e => e.preventDefault(), () => (0, _Router.gotoRoute)("/graduates"), () => (0, _Router.gotoRoute)("/graduates/animationgamedesign"), () => (0, _Router.gotoRoute)("/graduates/digitaldesign"), () => (0, _Router.gotoRoute)("/graduates/graphicdesign"), () => (0, _Router.gotoRoute)("/about"), this.menuClick, this.menuClick, this.menuClick);
  }
