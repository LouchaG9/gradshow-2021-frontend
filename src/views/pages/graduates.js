...
class GraduatesView {
  ...
  render(){
    const template = html`
      ...
      <va-app-header title="Shop" user="${JSON.stringify(Auth.currentUser)}"></va-app-header>
      <div class="page-content">
        ...
        <section class="search-and-filter-container">
          ...
          <div class="search-input-container">
            <input class="search-input" type="search" @keyup=${this.handleSearchKeyup.bind(this)} placeholder="Search" />
          ...
          <label class="dropdown">
            ...
            <ul class="dd-menu">
              <li size="small" @click=${this.clearFilters.bind(this)}>All Employees</li>
              <li class="divider"></li>
              <li class="filter-btn" size="small" data-field="major" data-match="animation-and-game-design" @click=${this.handleFilterBtn.bind(this)}>Animation & Game Design</li>
              <li class="divider"></li>
              <li class="filter-btn" size="small" data-field="major" data-match="graphic-design" @click=${this.handleFilterBtn.bind(this)}>Graphic Design</li>
              <li class="divider"></li>
              <li class="filter-btn" size="small" data-field="major" data-match="digital-design" @click=${this.handleFilterBtn.bind(this)}>Digital Design</li>
            </ul>
          </label>
        ...
        <section class="all-graduates-container">
          ...
          <div class="graduate-grid">
            ${this.graduates == null ? html `
              <sl-spinner></sl-spinner>
            ` : html `
              ${this.graduates.map(graduate => html`
